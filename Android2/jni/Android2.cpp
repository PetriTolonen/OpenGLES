...
extern "C" {
	JNIEXPORT void JNICALL Java_com_yritys_pelio_GL2JNILib_init(JNIEnv * env, jobject obj, jint width, jint height);
	JNIEXPORT void JNICALL Java_com_yritys_pelio_GL2JNILib_step(JNIEnv * env, jobject obj);
};
